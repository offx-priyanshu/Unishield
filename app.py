...
def check_overdue_outpasses(app):
    with app.app_context():
        ...
        # Find all students who are out and late
        ...
        for op in late_outpasses:
            ...
            if student:
                ...
                # 3. Blacklist after 3 violations
...
def cleanup_old_system_logs(app):
    with app.app_context():
        ...
        # Cleanup login/logout/terminated activity logs
...
def create_app():
    ...
    os.makedirs(
        os.path.join(upload_folder, 'signatures'),
        exist_ok=True
    )

    os.makedirs(
        os.path.join(upload_folder, 'stamps'),
        exist_ok=True
    )
    ...
    with app.app_context():
        ...
        # IMPORTANT:
        # Find only the configured OWNER admin.
        ...
        if not admin_user:
            ...
            # Keep existing owner admin.
            # Only update the owner admin password.
            # Other approved admin accounts remain unchanged.
